...
class LettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post letters_url, params: { letter: { content: @letter.content, is_draft: @letter.is_draft, published: @letter.published, recieved: @letter.recieved } }
    end
  ...
  test "should update letter" do
    patch letter_url(@letter), params: { letter: { content: @letter.content, is_draft: @letter.is_draft, published: @letter.published, recieved: @letter.recieved } }
